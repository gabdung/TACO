...
style.setProperty('--image-file-chromeLeft', 'url(\"' + new URL('./chromeLeft.png',import.meta.url).toString() + '\")');
style.setProperty('--image-file-chromeMiddle', 'url(\"' + new URL('./chromeMiddle.png',import.meta.url).toString() + '\")');
style.setProperty('--image-file-chromeRight', 'url(\"' + new URL('./chromeRight.png',import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-nodeIcon', 'url(\"' + new URL('./nodeIcon.png',import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-chromeLeft_mac', 'url(\"' + new URL('./chromeLeft_mac.png',import.meta.url).toString() + '\")');
style.setProperty('--image-file-chromeMiddle_mac', 'url(\"' + new URL('./chromeMiddle_mac.png',import.meta.url).toString() + '\")');
style.setProperty('--image-file-chromeRight_mac', 'url(\"' + new URL('./chromeRight_mac.png',import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-resourcesTimeGraphIcon', 'url(\"' + new URL('./resourcesTimeGraphIcon.png',import.meta.url).toString() + '\")');
style.setProperty('--image-file-resourcesTimeGraphIcon_edge', 'url(\"' + new URL('./resourcesTimeGraphIcon_edge.png',import.meta.url).toString() + '\")');
style.setProperty('--image-file-whatsnew', 'url(\"' + new URL('./whatsnew.png',import.meta.url).toString() + '\")');
style.setProperty('--image-file-breakpoint-conditional-disabled', 'url(\"' + new URL(new URL('breakpoint-conditional-disabled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-breakpoint-conditional', 'url(\"' + new URL(new URL('breakpoint-conditional.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-breakpoint-disabled', 'url(\"' + new URL(new URL('breakpoint-disabled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-breakpoint', 'url(\"' + new URL(new URL('breakpoint.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-cube', 'url(\"' + new URL(new URL('cube.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-debugging-preset-icon-filled', 'url(\"' + new URL(new URL('debugging-preset-icon-filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-debugging-preset-icon', 'url(\"' + new URL(new URL('debugging-preset-icon.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-default-preset-icon-filled', 'url(\"' + new URL(new URL('default-preset-icon-filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-default-preset-icon', 'url(\"' + new URL(new URL('default-preset-icon.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-device-emulation-focus-mode', 'url(\"' + new URL(new URL('device-emulation-focus-mode.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-device-mode', 'url(\"' + new URL(new URL('device-mode.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-down_filled', 'url(\"' + new URL(new URL('down_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-ABL-adapt_to_location', 'url(\"' + new URL(new URL('edge-ABL-adapt_to_location.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-ABL-move_to_left', 'url(\"' + new URL(new URL('edge-ABL-move_to_left.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-ABL-move_to_right', 'url(\"' + new URL(new URL('edge-ABL-move_to_right.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-ABL-move_to_top', 'url(\"' + new URL(new URL('edge-ABL-move_to_top.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-QV-bottom_collapse', 'url(\"' + new URL(new URL('edge-QV-bottom_collapse.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-QV-bottom_open', 'url(\"' + new URL(new URL('edge-QV-bottom_open.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-QV-dock-to-bottom', 'url(\"' + new URL(new URL('edge-QV-dock-to-bottom.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-QV-dock-to-right', 'url(\"' + new URL(new URL('edge-QV-dock-to-right.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-QV-side_collapse', 'url(\"' + new URL(new URL('edge-QV-side_collapse.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-QV-side_open', 'url(\"' + new URL(new URL('edge-QV-side_open.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-activity_bar_layout', 'url(\"' + new URL(new URL('edge-ABL-move_to_left.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-animations', 'url(\"' + new URL(new URL('edge-animations.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-autofill-view', 'url(\"' + new URL(new URL('edge-autofill-view.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-changes-changes', 'url(\"' + new URL(new URL('edge-changes-changes.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-chrome-recorder', 'url(\"' + new URL(new URL('edge-chrome-recorder.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-console', 'url(\"' + new URL(new URL('edge-console.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-console_filled', 'url(\"' + new URL(new URL('edge-console_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-copilot-filled', 'url(\"' + new URL(new URL('edge-copilot-filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-copilot', 'url(\"' + new URL(new URL('edge-copilot.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-coverage', 'url(\"' + new URL(new URL('edge-coverage.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-csp-violations-pane', 'url(\"' + new URL(new URL('edge-csp-violations-pane.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-cssoverview', 'url(\"' + new URL(new URL('edge-cssoverview.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-debugger-breakpoint-circle', 'url(\"' + new URL(new URL('edge-debugger-breakpoint-circle.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-debugger-breakpoint-conditional', 'url(\"' + new URL(new URL('edge-debugger-breakpoint-conditional.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-debugger-breakpoint-diamond', 'url(\"' + new URL(new URL('edge-debugger-breakpoint-diamond.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-developer-resources', 'url(\"' + new URL(new URL('edge-developer-resources.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-dock_side_layout', 'url(\"' + new URL(new URL('edge-dock_side_layout.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-documentation', 'url(\"' + new URL(new URL('edge-documentation.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-documentation_book_filled', 'url(\"' + new URL(new URL('edge-documentation_book_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-documentation_filled', 'url(\"' + new URL(new URL('edge-documentation_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-dom3d', 'url(\"' + new URL(new URL('edge-dom3d.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-drawer_visibility', 'url(\"' + new URL(new URL('edge-drawer_visibility.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-elements', 'url(\"' + new URL(new URL('edge-elements.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-generic-tool', 'url(\"' + new URL(new URL('edge-layers.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-heap-profiler', 'url(\"' + new URL(new URL('edge-heap-profiler.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-help', 'url(\"' + new URL(new URL('edge-help.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-help_tooltips', 'url(\"' + new URL(new URL('edge-help_tooltips.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-help_tooltips_filled', 'url(\"' + new URL(new URL('edge-help_tooltips_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-input-clear-button-dark-hover', 'url(\"' + new URL(new URL('edge-input-clear-button-dark-hover.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-input-clear-button-dark', 'url(\"' + new URL(new URL('edge-input-clear-button-dark.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-input-clear-button-hover', 'url(\"' + new URL(new URL('edge-input-clear-button-hover.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-input-clear-button', 'url(\"' + new URL(new URL('edge-input-clear-button.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-issues-pane', 'url(\"' + new URL(new URL('edge-issues-pane.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-js_profiler', 'url(\"' + new URL(new URL('edge-js_profiler.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-keyboard_shortcuts', 'url(\"' + new URL(new URL('edge-keyboard_shortcuts.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-layers', 'url(\"' + new URL(new URL('edge-layers.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-lighthouse', 'url(\"' + new URL(new URL('edge-lighthouse.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-linear-memory-inspector', 'url(\"' + new URL(new URL('edge-linear-memory-inspector.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-maps', 'url(\"' + new URL(new URL('edge-maps.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-medias', 'url(\"' + new URL(new URL('edge-medias.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-mfb-thumbsDown-selected', 'url(\"' + new URL(new URL('edge-mfb-thumbsDown-selected.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-mfb-thumbsDown-unselected', 'url(\"' + new URL(new URL('edge-mfb-thumbsDown-unselected.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-mfb-thumbsUp-selected', 'url(\"' + new URL(new URL('edge-mfb-thumbsUp-selected.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-mfb-thumbsUp-unselected', 'url(\"' + new URL(new URL('edge-mfb-thumbsUp-unselected.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-network-blocked-urls', 'url(\"' + new URL(new URL('edge-network-blocked-urls.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-network-config', 'url(\"' + new URL(new URL('edge-network-config.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-network', 'url(\"' + new URL(new URL('edge-network.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-open_file', 'url(\"' + new URL(new URL('edge-open_file.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-performance-monitor', 'url(\"' + new URL(new URL('edge-performance-monitor.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-release_notes', 'url(\"' + new URL(new URL('edge-release_notes.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-remove_tab_icon', 'url(\"' + new URL(new URL('edge-remove_tab_icon.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-rendering', 'url(\"' + new URL(new URL('edge-rendering.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-resourceDocumentIconSmall', 'url(\"' + new URL(new URL('edge-resourceDocumentIconSmall.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-resources', 'url(\"' + new URL(new URL('edge-resources.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-run_command', 'url(\"' + new URL(new URL('play.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-run_command_filled', 'url(\"' + new URL(new URL('edge-run_command_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-search-info', 'url(\"' + new URL(new URL('edge-search-info.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-security', 'url(\"' + new URL(new URL('edge-security.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-sensors', 'url(\"' + new URL(new URL('edge-layers.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-settings', 'url(\"' + new URL(new URL('edge-settings.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-small-error', 'url(\"' + new URL(new URL('edge-small-error.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-small-info', 'url(\"' + new URL(new URL('info-filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-small-tip', 'url(\"' + new URL(new URL('edge-small-tip.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-small-warning', 'url(\"' + new URL(new URL('warning-filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-sources-quick', 'url(\"' + new URL(new URL('edge-sources-quick.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-sources-search-sources-tab', 'url(\"' + new URL(new URL('edge-sources-search-sources-tab.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-sources.search-sources-tab_filled', 'url(\"' + new URL(new URL('edge-sources.search-sources-tab_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-sources', 'url(\"' + new URL(new URL('edge-sources.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-sources_filled', 'url(\"' + new URL(new URL('edge-sources_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-symbol-server', 'url(\"' + new URL(new URL('edge-symbol-server.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-themes', 'url(\"' + new URL(new URL('edge-themes.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-timeline', 'url(\"' + new URL(new URL('edge-timeline.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-treeoutlineTriangles', 'url(\"' + new URL(new URL('edge-treeoutlineTriangles.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-web-audio', 'url(\"' + new URL(new URL('edge-web-audio.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-webauthn-pane', 'url(\"' + new URL(new URL('edge-webauthn-pane.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-edge-welcome', 'url(\"' + new URL(new URL('edge-welcome.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-extension-panel_edge', 'url(\"' + new URL(new URL('puzzle_edge.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-feedback-large-icon_edge', 'url(\"' + new URL(new URL('feedback-large-icon_edge.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-inspect-focus-mode', 'url(\"' + new URL(new URL('inspect-focus-mode.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-layout-preset-icon-filled', 'url(\"' + new URL(new URL('layout-preset-icon-filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-layout-preset-icon', 'url(\"' + new URL(new URL('layout-preset-icon.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-left_filled', 'url(\"' + new URL(new URL('left_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-logpoint-disabled', 'url(\"' + new URL(new URL('logpoint-disabled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-logpoint', 'url(\"' + new URL(new URL('logpoint.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-more-menu-icon', 'url(\"' + new URL(new URL('more-menu-icon.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-network-preset-icon-filled', 'url(\"' + new URL(new URL('network-preset-icon-filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-network-preset-icon', 'url(\"' + new URL(new URL('network-preset-icon.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-optimization-preset-icon-filled', 'url(\"' + new URL(new URL('optimization-preset-icon-filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-optimization-preset-icon', 'url(\"' + new URL(new URL('optimization-preset-icon.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-puzzle_edge', 'url(\"' + new URL(new URL('puzzle_edge.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-question-mark', 'url(\"' + new URL(new URL('question-mark.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-right_filled', 'url(\"' + new URL(new URL('right_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-squiggly', 'url(\"' + new URL(new URL('squiggly.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-tooltips-focus-mode', 'url(\"' + new URL(new URL('tooltips-focus-mode.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-up_filled', 'url(\"' + new URL(new URL('up_filled.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-cssoverview_icons_2x', 'url(\"' + new URL('./cssoverview_icons_2x.png',import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-bottom-panel-close', 'url(\"' + new URL(new URL('top-panel-open.svg',import.meta.url).href,import.meta.url).toString() + '\")');
style.setProperty('--image-file-bottom-panel-open', 'url(\"' + new URL(new URL('top-panel-close.svg',import.meta.url).href,import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-cross-circle-filled', 'url(\"' + new URL(new URL('edge-small-error.svg',import.meta.url).href,import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-file-generic', 'url(\"' + new URL(new URL('stop.svg',import.meta.url).href,import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-filter-filled', 'url(\"' + new URL(new URL('filter-clear.svg',import.meta.url).href,import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-gear-filled', 'url(\"' + new URL(new URL('gear.svg',import.meta.url).href,import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-resume', 'url(\"' + new URL(new URL('play.svg',import.meta.url).href,import.meta.url).toString() + '\")');
