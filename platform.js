...
var c = Object.freeze({
    __proto__: null,
    deepActiveElement: function(e) {
        let t = e.activeElement;
        for (; t?.shadowRoot?.activeElement; )
            t = t.shadowRoot.activeElement;
        return t
    },
    getEnclosingShadowRootForNode: function(e) {
        let t = e.parentNodeOrShadowHost();
        for (; t; ) {
            if (t instanceof ShadowRoot)
                return t;
            t = t.parentNodeOrShadowHost()
        }
        return null
    },
    rangeOfWord: function(e, t, r, n, o) {
        let i, a, s = 0, l = 0;
        if (n || (n = e),
        o && "backward" !== o && "both" !== o)
            i = e,
            ...
            for (; o; ) {
                ...
                if (o.nodeType === Node.TEXT_NODE && null !== o.nodeValue) {
                    for (let n = o === e ? t - 1 : o.nodeValue.length - 1; n >= 0; --n)
                        if (-1 !== r.indexOf(o.nodeValue[n])) {
                            i = o,
                            s = n + 1;
                            break
                        }
                ...
                if (i)
                    break;
                o = o.traversePreviousNode(n)
            }
            i || (i = n,
            s = 0)
        }
        if (o && "forward" !== o && "both" !== o)
            a = e,
            l = t;
        else {
            let o = e;
            for (; o; ) {
                ...
                if (o.nodeType === Node.TEXT_NODE && null !== o.nodeValue) {
                    for (let n = o === e ? t : 0; n < o.nodeValue.length; ++n)
                        if (-1 !== r.indexOf(o.nodeValue[n])) {
                            a = o,
                            l = n;
                            break
                ...
                if (a)
                    break;
                o = o.traverseNextNode(n)
            }
            a || (a = n,
            l = n.nodeType === Node.TEXT_NODE ? n.nodeValue?.length || 0 : n.childNodes.length)
        }
        if (!e.ownerDocument)
            throw new Error("No `ownerDocument` found for rootNode");
        const u = e.ownerDocument.createRange();
        return u.setStart(i, s),
        u.setEnd(a, l),
        u
    }
});
const f = new Set(["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"]);
var h = Object.freeze({
    __proto__: null,
    ARROW_KEYS: f,
    ENTER_KEY: "Enter",
...
const d = new Set(["application/ecmascript", "application/javascript", "application/json", "application/json+protobuf", "application/mpegurl", "application/vnd.apple.mpegurl", "application/vnd.dart", "application/xml", "application/x-aspx", "application/x-javascript", "application/x-jsp", "application/x-httpd-php", "application/x-mpegurl", "audio/mpegurl", "audio/x-mpegurl"]);
function m(e, t, r=0) {
...
var w = Object.freeze({
    ...
    isTextType: function(e) {
        return e.startsWith("text/") || e.startsWith("multipart/") || e.includes("+json") || e.endsWith("+xml") || d.has(e)
    },
...
const O = (e, t) => {
  ...
  , N = (e, t) => e.toString(16).toUpperCase().padStart(t, "0")
  ...
  , U = /[A-Z]{2,}(?=[A-Z0-9][a-z0-9]+|\b|_)|[A-Za-z][0-9]+[a-z]?|[A-Z]?[a-z]+|[0-9][A-Za-z]+|[A-Z]|[0-9]+|[.]/g
  , z = function(e) {
    return e.match?.(U)?.map((e => e.toLowerCase())).join("-").replaceAll("-.-", ".") || e
};
var L = Object.freeze({
    __proto__: null,
    DOUBLE_QUOTE: '"',
    ...
    concatBase64: function(e, t) {
        ...
        return r + window.btoa(window.atob(n) + window.atob(t))
    },
        ...
        const t = /(\\|<(?:!--|\/?script))|(\p{Control})|(\p{Surrogate})/gu
          ...
          , n = (e, t, r, n) => {
            if (r) {
                if (y.has(r))
                    return y.get(r);
                return "\\x" + N(r.charCodeAt(0), 2)
            }
            if (n) {
                return "\\u" + N(n.charCodeAt(0), 4)
            }
            return t ? y.get(t) || "" : e
        }
        ;
    ...
    isExtendedKebabCase: e => S.test(e),
